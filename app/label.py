...
class MainWindow_Label(QMainWindow, WindowMixin):
    FIT_WINDOW, FIT_WIDTH, MANUAL_ZOOM = list(range(3))
    sig_action = QtCore.pyqtSignal(str)

    def __init__(self, parent=None, defaultFilename=None, defaultPrefdefClassFile=None):
        super(MainWindow_Label, self).__init__(parent)
        ...
        quit = action('&Quit', self.closeEvent,
        ...
        self.actions = struct(save=save, saveAs=saveAs, open=open,
        ...
        self.actions.beginner = (
            openNextImg, openPrevImg, verify, save, None, create, copy, delete, None,
            zoomIn, zoom, zoomOut, fitWindow, fitWidth)

        self.actions.advanced = (
            openNextImg, openPrevImg, save, None,
        ...
        if self.filePath and os.path.isdir(self.filePath):
            ...
            self.defaultSaveDir = os.path.join(self.filePath, 'labels_voc')
    ...
    def resizeEvent(self, event):
        if self.canvas and not self.image.isNull()\
           and self.zoomMode != self.MANUAL_ZOOM:
            self.adjustScale()
        super(MainWindow_Label, self).resizeEvent(event)
    ...
    def closeFile(self, _value=False):
        ...
        # convert_voc2yolo(self.defaultSaveDir, self.defaultSaveDir.replace('labels_voc', 'labels_yolo'))
        self.sig_action.emit('convert_voc2yolo')
