...
class SimrdwnThread(QtCore.QThread):
    ...
    def __init__(self):
        ...
        self.args['test_add_geo_coords'] = 0
    ...
    def prep(self):
        ...
        return train_cmd1, test_cmd_tot

    ###############################################################################

    def execute(self, train_cmd1, test_cmd_tot):
        """
        ...
        # need to split file for test first, then run command
            ...
            if len(df_tot) > 0:
                for plot_thresh_tmp in self.args.plot_thresh:
                    ...
                    # save json
                    if bool(self.args.test_add_geo_coords) and bool(self.args.save_json) and json is not None and (len(json) > 0):
    ...
    def run(self):
        ...
        train_cmd1, test_cmd_tot = self.prep()
        self.execute(train_cmd1, test_cmd_tot)
